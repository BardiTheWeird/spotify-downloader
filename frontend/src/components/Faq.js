            ...
            <div className='infobox'>
                ...
                <p>
                    ...
                    <div className='infotext'>
                        Please notice: for a search of a private playlist e.g. Liked Tracks, please login using a dropdown button in upper-left corner. You can log out any time you want using the dropdown button under the profile name.
                    </div>
                    <div className='infotext'>
